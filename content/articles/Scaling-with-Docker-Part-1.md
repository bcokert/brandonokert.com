...
In this section we'll go over these [Tools](#tools) and [Components](#components) and where they fit, before touching on the prevailing [Docker Ideologies](#docker-ideologies).
